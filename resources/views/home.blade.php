...
<link rel="icon" href="{{asset('images/blackhole.png')}}" type="image/x-icon"> <link rel="stylesheet"
    href="{{asset('../css/home.css')}}"> <title>Home page</title>
</head> <body> <section class="showcase">
<header>
